...
\begin{titlepage}
	...
	\begin{center}
		{\fontsize{36pt}{36pt}\fontfamily{lmr}\selectfont 博~\:士~\:学~\:位~\:论~\:文}\vspace{2cm}
...
\begin{multicols}{2}
	\vfill\null
	\columnbreak
	\textbf{作者签名:}~~~~\includegraphics[width=0.3\columnwidth]{media/sign.jpg} %括号里是作者电子签
	\par
	\vspace{0.3cm}
\end{multicols}
...
\textbf{作者签名: }\includegraphics[width=0.125\columnwidth]{media/sign.jpg} %括号里是作者电子签
~~~~~~~~~~~~~~~
\textbf{导师签名: }\includegraphics[width=0.125\columnwidth]{media/sign.jpg}\includegraphics[width=0.15\columnwidth]{media/sign.jpg} %二位导师签名
\par
\hspace{1cm}
